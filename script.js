  ...
  switch(skill) {
    ...
    case 'listening':
      activitySection.innerHTML = `
        ...
        <audio controls>
          <source src="assets/The%20Bear%20and%20The%20Bee%20-%20US%20English%20accent%20(TheFableCottage.com).mp3" type="audio/mpeg">
...
function checkAnswer(answer) {
  const activitySection = document.getElementById('activity');
  if (answer === 'playing' || answer === 'bear' || answer === 'bee') {
